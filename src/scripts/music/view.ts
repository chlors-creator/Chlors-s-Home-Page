...
export function createPlayerView(root: HTMLElement, controller: PlayerController, localTracks: Track[], localQueue: Queue | undefined, lyricsController: LyricsController): PlayerView {
